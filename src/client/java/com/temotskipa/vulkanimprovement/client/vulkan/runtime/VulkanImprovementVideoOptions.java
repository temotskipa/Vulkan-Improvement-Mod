...
public final class VulkanImprovementVideoOptions {
    ...
    public static OptionInstance<?>[] createOptions() {
        ...
        return new OptionInstance[]{
                ...
                terrainFragmentShadingRateSize,
                presentPacing,
                waitIdleBeforeTerrainUpload,
                allowCpuVisibleMeshletFallback,
                gpuGeneratedMeshTaskCommands,
                dumpCapabilities,
                requireVulkanBackend,
                validationDescriptorBufferOnly,
                initialSectionCapacity,
                initialMeshletCapacity,
                initialVertexPayloadMib,
                initialIndexPayloadMib,
                terrainMirrorStabilizationMillis
        };
    }
    ...
    private static void ensureOptions() {
        ...
        strictMeshTerrainReplacement = OptionInstance.createBoolean(
                "options.vulkanimprovement.strictMeshTerrainReplacement",
                OptionInstance.cachedConstantTooltip(Component.translatable("options.vulkanimprovement.strictMeshTerrainReplacement.tooltip")),
                TerrainRendererDebugConfig.strictMeshTerrainReplacement(),
        ...
        terrainFragmentShadingRateSize = intOption(
                "options.vulkanimprovement.terrainFragmentShadingRateSize",
                1,
                4,
                TerrainRendererDebugConfig.terrainFragmentShadingRate(),
                TerrainRendererDebugConfig::setTerrainFragmentShadingRate
        );
        presentPacing = OptionInstance.createBoolean(
                "options.vulkanimprovement.presentPacing",
                OptionInstance.cachedConstantTooltip(Component.translatable("options.vulkanimprovement.presentPacing.tooltip")),
                !TerrainRendererDebugConfig.disablePresentPacing(),
                enabled -> TerrainRendererDebugConfig.setDisablePresentPacing(!enabled)
        );
        waitIdleBeforeTerrainUpload = OptionInstance.createBoolean(
                "options.vulkanimprovement.waitIdleBeforeTerrainUpload",
                OptionInstance.cachedConstantTooltip(Component.translatable("options.vulkanimprovement.waitIdleBeforeTerrainUpload.tooltip")),
                TerrainRendererDebugConfig.waitIdleBeforeTerrainUpload(),
                TerrainRendererDebugConfig::setWaitIdleBeforeTerrainUpload
        );
        allowCpuVisibleMeshletFallback = OptionInstance.createBoolean(
                "options.vulkanimprovement.allowCpuVisibleMeshletFallback",
                OptionInstance.cachedConstantTooltip(Component.translatable("options.vulkanimprovement.allowCpuVisibleMeshletFallback.tooltip")),
                TerrainRendererDebugConfig.allowCpuVisibleMeshletFallback(),
                TerrainRendererDebugConfig::setAllowCpuVisibleMeshletFallback
        );
        gpuGeneratedMeshTaskCommands = OptionInstance.createBoolean(
                "options.vulkanimprovement.gpuGeneratedMeshTaskCommands",
                OptionInstance.cachedConstantTooltip(Component.translatable("options.vulkanimprovement.gpuGeneratedMeshTaskCommands.tooltip")),
                TerrainRendererDebugConfig.enableGpuGeneratedMeshTaskCommands(),
                TerrainRendererDebugConfig::setEnableGpuGeneratedMeshTaskCommands
        );
        dumpCapabilities = OptionInstance.createBoolean(
                "options.vulkanimprovement.dumpCapabilities",
                OptionInstance.cachedConstantTooltip(Component.translatable("options.vulkanimprovement.dumpCapabilities.tooltip")),
                TerrainRendererDebugConfig.dumpCapabilities(),
                TerrainRendererDebugConfig::setDumpCapabilities
        );
        requireVulkanBackend = OptionInstance.createBoolean(
                "options.vulkanimprovement.requireVulkanBackend",
                OptionInstance.cachedConstantTooltip(Component.translatable("options.vulkanimprovement.requireVulkanBackend.tooltip")),
                TerrainRendererDebugConfig.requireVulkanBackend(),
                TerrainRendererDebugConfig::setRequireVulkanBackend
        );
        validationDescriptorBufferOnly = OptionInstance.createBoolean(
                "options.vulkanimprovement.validationDescriptorBufferOnly",
                OptionInstance.cachedConstantTooltip(Component.translatable("options.vulkanimprovement.validationDescriptorBufferOnly.tooltip")),
                TerrainRendererDebugConfig.validationDescriptorBufferOnly(),
                TerrainRendererDebugConfig::setValidationDescriptorBufferOnly
        );
        initialSectionCapacity = intOption(
                "options.vulkanimprovement.initialSectionCapacity",
                TerrainRendererDebugConfig.MIN_SECTION_CAPACITY,
                TerrainRendererDebugConfig.MAX_SECTION_CAPACITY,
                TerrainRendererDebugConfig.initialSectionCapacity(),
                TerrainRendererDebugConfig::setInitialSectionCapacity
        );
        initialMeshletCapacity = intOption(
                "options.vulkanimprovement.initialMeshletCapacity",
                TerrainRendererDebugConfig.MIN_MESHLET_CAPACITY,
                TerrainRendererDebugConfig.MAX_MESHLET_CAPACITY,
                TerrainRendererDebugConfig.initialMeshletCapacity(),
                TerrainRendererDebugConfig::setInitialMeshletCapacity
        );
        initialVertexPayloadMib = mibOption(
                "options.vulkanimprovement.initialVertexPayloadMib",
                TerrainRendererDebugConfig.MIN_VERTEX_PAYLOAD_MIB,
                TerrainRendererDebugConfig.MAX_VERTEX_PAYLOAD_MIB,
                TerrainRendererDebugConfig.initialVertexPayloadMib(),
                TerrainRendererDebugConfig::setInitialVertexPayloadMib
        );
        initialIndexPayloadMib = mibOption(
                "options.vulkanimprovement.initialIndexPayloadMib",
                TerrainRendererDebugConfig.MIN_INDEX_PAYLOAD_MIB,
                TerrainRendererDebugConfig.MAX_INDEX_PAYLOAD_MIB,
                TerrainRendererDebugConfig.initialIndexPayloadMib(),
                TerrainRendererDebugConfig::setInitialIndexPayloadMib
        );
        terrainMirrorStabilizationMillis = intOption(
                "options.vulkanimprovement.terrainMirrorStabilizationMillis",
                TerrainRendererDebugConfig.MIN_TERRAIN_MIRROR_STABILIZATION_MILLIS,
                TerrainRendererDebugConfig.MAX_TERRAIN_MIRROR_STABILIZATION_MILLIS,
                TerrainRendererDebugConfig.terrainMirrorStabilizationMillis(),
                TerrainRendererDebugConfig::setTerrainMirrorStabilizationMillis
        );
    }
    ...
    private static OptionInstance<Integer> intOption(String captionId, int minInclusive, int maxInclusive, int initialValue, IntConsumer onValueUpdate) {
        return new OptionInstance<>(
                ...
                new OptionInstance.IntRange(minInclusive, maxInclusive),
                initialValue,
    ...
    private static OptionInstance<Integer> mibOption(String captionId, int minInclusive, int maxInclusive, int initialValue, IntConsumer onValueUpdate) {
        return new OptionInstance<>(
                captionId,
                OptionInstance.cachedConstantTooltip(Component.translatable(captionId + ".tooltip")),
                (caption, value) -> Options.genericValueLabel(caption, Component.literal(value + " MiB")),
                new OptionInstance.IntRange(minInclusive, maxInclusive),
                initialValue,
                onValueUpdate::accept
        );
