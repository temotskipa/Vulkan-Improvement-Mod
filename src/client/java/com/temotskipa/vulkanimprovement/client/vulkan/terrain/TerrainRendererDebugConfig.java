...
public final class TerrainRendererDebugConfig {
    ...
    public static String describe() {
        return "rendererMode=" + rendererMode()
                ...
                + ", disablePresentPacing=" + disablePresentPacing()
                + ", validationDescriptorBufferOnly=" + validationDescriptorBufferOnly()
                + ", waitIdleBeforeTerrainUpload=" + waitIdleBeforeTerrainUpload()
                + ", allowCpuVisibleMeshletFallback=" + allowCpuVisibleMeshletFallback()
                + ", enableGpuGeneratedMeshTaskCommands=" + enableGpuGeneratedMeshTaskCommands()
                + ", terrainFragmentShadingRate=" + terrainFragmentShadingRate()
                + ", terrainMirrorStabilizationMillis=" + terrainMirrorStabilizationMillis()
                + ", initialSectionCapacity=" + initialSectionCapacity()
