...
public final class VulkanImprovementCapabilities {
    ...
    public static Snapshot capture(VulkanPhysicalDevice physicalDevice, Set<String> enabledDeviceExtensions) {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            if (physicalDevice.hasDeviceExtension(EXTDescriptorHeap.VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME)) {
    ...
    public record Snapshot(String deviceName, String vendorName, String driverInfo, String apiVersion,
                           ...
                           boolean presentIdExtension, boolean presentWaitExtension, int maxMeshOutputVertices,
                           int maxMeshOutputPrimitives, int maxPreferredTaskWorkGroupInvocations,
                           int maxPreferredMeshWorkGroupInvocations, long maxSamplerHeapSize, long maxResourceHeapSize,
                           long samplerDescriptorSize, long imageDescriptorSize, long bufferDescriptorSize,
                           long descriptorBufferOffsetAlignment, int maxResourceDescriptorBufferBindings,
                           int maxSamplerDescriptorBufferBindings, long descriptorBufferSamplerDescriptorSize,
                           long descriptorBufferSampledImageDescriptorSize,
        ...
        static Snapshot empty() {
            return new Snapshot("unknown", "unknown", "unknown", "unknown", TerrainRendererDebugConfig.rendererMode(), false, false, false, false, false, false, 0, 0, 0, 0, 0L, 0L, 0L, 0L, 0L, 0L, 0, 0, 0L, 0L, 0L, 0L, 0L, 0L, 0, 0, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false);
        }
