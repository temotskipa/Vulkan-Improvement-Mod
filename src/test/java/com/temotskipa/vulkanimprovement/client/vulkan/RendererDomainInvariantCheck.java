...
public final class RendererDomainInvariantCheck {
    ...
    private static void checkTerrainMeshPathKeepsOtherDomainsVanilla() {
        RendererDomainRegistry registry = RendererDomainRegistry.get();
        registry.reset();
        registry.set(RendererDomain.TERRAIN, RendererDomainRegistry.DomainState.meshTerrain("test terrain path"));
        ...
        require(Boolean.FALSE.equals(terrain.get("gpuWorkQueues")), "current terrain path must not claim GPU work queues yet");
