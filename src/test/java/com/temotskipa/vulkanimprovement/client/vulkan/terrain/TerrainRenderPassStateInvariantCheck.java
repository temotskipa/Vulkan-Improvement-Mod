...
public final class TerrainRenderPassStateInvariantCheck {
    ...
    private static void checkRenderPassRestoresVanillaPipelineState(String source) {
        ...
        require(source.contains("VK12.vkCmdBindPipeline(this.commandBuffer(), VK10.VK_PIPELINE_BIND_POINT_GRAPHICS"), "render-pass mixin must rebind the native vanilla graphics pipeline");
